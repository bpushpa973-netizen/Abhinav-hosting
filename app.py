...
def create_default_files(server_dir):
    ...
    if not os.path.exists(main_py):
        with open(main_py, 'w', encoding='utf-8') as f:
            f.write('''# ABHINAV HOSTING - Default Bot
import time

print("=" * 40)
print("Bot is running on Abhinav HOSTING")
...
def api_create_server():
    ...
    if not username:
        username = f"AbhinavBroken{random.randint(10000, 99999)}"
